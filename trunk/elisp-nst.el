;;; File elisp-nst.el
;;;
;;;   Sample basic Emacs configuration for NST
;;;
;;; Copyright (c) 2009-2014 Smart Information Flow Technologies.
...
(nst-form-indentation def-criterion 1)
(nst-form-indentation nst:def-criterion 1)
(nst-form-indentation def-criterion-unevaluated 1)
(nst-form-indentation nst:def-criterion-unevaluated 1)
...
(nst-form-indentation with-criterion-name-args 2)
