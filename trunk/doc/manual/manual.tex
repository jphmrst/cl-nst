...
\noindent This document is the manual and users' guide to the
2.0.$x$\footnote{The 1.3.x series was renamed to 2.0.x, since uses of
  certain low-level criteria definers became non-backward compatible.}
