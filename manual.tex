...
\subsubsection{The \texttt{:check-err} check \fbox{REDO}}
...
\subsubsection{The \texttt{:seq} check \fbox{REDO}}
...
\subsubsection{The \texttt{:permute} check \fbox{REDO}}
...
\subsubsection{The \texttt{:across} check \fbox{REDO}} 
...
\subsubsection{The \texttt{:slots} check \fbox{REDO}} 
